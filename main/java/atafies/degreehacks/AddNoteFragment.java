...
public class AddNoteFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(atafies.degreehacks.R.layout.fragment_add_note);
        dialog.getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        Button addIt = (Button)dialog.findViewById(atafies.degreehacks.R.id.button_add_note);
        addIt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onAddButtonPressed(AddNoteFragment.this);
                dismiss();
            }
        });
