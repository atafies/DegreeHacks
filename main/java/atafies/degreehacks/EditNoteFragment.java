...
public class EditNoteFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        saveIt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onSaveNotePress(EditNoteFragment.this,id,position);
                dismiss();
            }
        });
        deleteIt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onDeleteNotePress(EditNoteFragment.this, id, position);
                dismiss();
            }
        });
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (EditNoteFragment.OnEditNoteListener) activity;
