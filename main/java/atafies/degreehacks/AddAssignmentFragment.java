...
public class AddAssignmentFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(atafies.degreehacks.R.layout.fragment_add_assignment);
        dialog.getWindow().setSoftInputMode(
                WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE);
        Button addIt = (Button)dialog.findViewById(atafies.degreehacks.R.id.button_add_assignment);
        addIt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onAddButtonPressed(AddAssignmentFragment.this);
                dismiss();
            }
        });
